...
bool uzfs_fs_prop_get(uzfs_ptr_t *, const char *, char *, size_t);
bool uzfs_fs_prop_set(uzfs_ptr_t *, const char *, const char *, char **);

bool uzfs_fs_prop_get_numeric(uzfs_ptr_t *, const char *, uint64_t *);
bool uzfs_fs_prop_set_numeric(uzfs_ptr_t *, const char *, uint64_t, char **);
